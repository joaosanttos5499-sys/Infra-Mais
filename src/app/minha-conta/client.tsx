                          ...
                          <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormControl>
                                      <Input {...field} disabled={!isEditingName} className="h-10 dark:bg-white/5 dark:text-slate-300/60 dark:disabled:opacity-100" />
                                  </FormControl>
                                  <FormMessage />
                                </FormItem>
                              )}
                            ...
                            <div className="space-y-4 pt-2">
                                <div className="space-y-1">
                                    ...
                                    <Input value={userProfile?.email || user.email || ''} disabled className="h-10 dark:bg-white/5 dark:text-slate-300/60 dark:disabled:opacity-100" />
                                </div>

                                <div className="space-y-1">
                                    <Label className="text-sm font-medium">Data de Nascimento</Label>
                                    <Input value={userProfile?.dateOfBirth || 'Não informada'} disabled className="h-10 dark:bg-white/5 dark:text-slate-300/60 dark:disabled:opacity-100" />
                                </div>
                            </div>
